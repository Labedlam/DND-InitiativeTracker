<template>
  <div class="hello">
    <h1>{{ msg }}</h1>
    <p>Roll a d20, add your dexterity</p>
    <button class="btn btn-primary btn-lg" type="button" v-on:click="startRound">Begin</button>
...
export default {
  ...
  methods: {
    startRound: function(){
      ...
      // this.$set(this.currentRound, round);
      this.$router.push('initiatitve-form');
    }
  }
